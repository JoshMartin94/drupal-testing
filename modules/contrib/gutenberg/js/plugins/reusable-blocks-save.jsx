        ...
        {dirtyEntityRecords.length > 0 && (
          ...
          >
            <PanelBody>
              <BaseControl
                help={__(
                  'Saving reusable blocks will affect other places where they are being used. You can de-select to not save.',
                )}
              >
                <BaseControl.VisualLabel>
                  {__(
                    'The selected reusable blocks will be saved when saving the content. Press "Save now" button to save immediately.',
                  )}
                </BaseControl.VisualLabel>
              </BaseControl>
