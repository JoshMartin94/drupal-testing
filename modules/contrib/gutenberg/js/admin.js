    ...
    attach(context) {
      const $elements = $(
        once(
          ...
          '.view-reusable-blocks .views-view-responsive-grid__item',
          context,
        ),
      );
...
window.moreSettingsClick = (element) => {
  // When clicking, the element expands. Scroll enough so user can see the More Settings content.
  setTimeout(() => {
