...
class ContentBlockSettingsForm extends FormBase implements BaseFormIdInterface {
  ...
  public static function processBlockForm(array $element, FormStateInterface $form_state) {
    ...
    $element['field_article']['widget']['#theme'] = 'field_multiple_value_form__gutenberg';
  ...
  public static function afterBuildBlockForm(array $element, FormStateInterface $form_state) {
    // $element['#attached']['library'][] = 'gutenberg/drupal-block-settings';
    // kint($element['field_article']);
    // $element['field_article']['widget']['#theme'] = 'field_multiple_value_form__gutenberg';
    return $element;
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $type = NULL, $block_id = NULL, $config = []) {
    ...
    // $block = new BlockContent([], 'block_content', $type);
